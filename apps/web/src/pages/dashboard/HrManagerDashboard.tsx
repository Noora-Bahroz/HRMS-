...
export function HrManagerDashboard() {
  ...
  const stats = [
    ...
    { label: "Candidates", value: String(d.recruitment.candidates), icon: Users, tone: "bg-rose-100 text-rose-700" },
  ...
  return (
    <div>
      <PageHeader
        ...
        subtitle={`${me?.fullName ? "Welcome back" : "Welcome"} — ${active} active employees, ${d.leave.pending} leave request(s) awaiting your approval.`}
        actions={
      ...
      <div className="mt-6 grid grid-cols-1 gap-4 lg:grid-cols-4">
        ...
        <Card className="p-4">
          ...
          <div className="mt-4 flex items-center gap-1.5 rounded-md bg-gray-50 px-3 py-2 text-xs text-gray-500 dark:bg-neutral-800">
            <FolderOpen size={13} />
            Employment history & personnel files.
          </div>
        </Card>
      </div>
      ...
      <div className="mt-6 grid grid-cols-1 gap-4 lg:grid-cols-2">
        <Card className="p-4">
          <h3 className="mb-3 text-sm font-semibold text-gray-800">Employee Overview by Status</h3>
        ...
        <Link to="/reports">
          <Card className="flex items-center justify-between p-4 transition-shadow hover:shadow-md">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="text-sm font-semibold text-gray-800">HR Reports</div>
